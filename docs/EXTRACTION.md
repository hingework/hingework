...
- **NOT TESTED — actual history gate:** pending creation of the first public commits; no previous empty-history scan is treated as evidence for committed history.
